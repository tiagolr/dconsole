...
class ApplicationMain {
	...
	public static function main () {
		...
		//nme.Lib.setPackage("Example, Inc.", "test", "com.example.myapp", "1.0.0");
	...
	private static function start ():Void {
		...
		var hasMain = false;
		var mainClass = Type.resolveClass ("TestRunner");
...
class ApplicationMain {
	...
	public static function main () {
		...
		for (methodName in Type.getClassFields (TestRunner)) {
		...
		if (hasMain) {
			...
			Reflect.callMethod (TestRunner, Reflect.field (TestRunner, "main"), []);
...
@:keep class DocumentClass extends TestRunner { }
